...
const UserDashboard = () => {
  ...
  const profit = 20259.00;
  const totalInvestment = 17021.00;
  const totalBalance = 37280.00;
      ...
      setCryptoDetails((prevDetails) =>
        prevDetails.map((crypto) => {
          if (crypto.symbol === "BTC") {
            const newPrice = Math.max(87000, crypto.price - 1000); // Simulate BTC drop to 76000
