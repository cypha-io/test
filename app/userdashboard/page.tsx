...
const UserDashboard = () => {
  ...
  const profit = 1123.00;
  const totalInvestment = 4215.00;
  const totalBalance = 5147.00;
      ...
      <main className="flex flex-col gap-8 items-center sm:items-start">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mt-4 w-full">
          <div className="card bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md w-full">
            ...
            <p className="text-black dark:text-white">6</p>
          </div>
          <div className="card bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md w-full">
          ...
          <div className="card bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md w-full">
            ...
            <p className="text-black dark:text-white">0.051687 BTC</p>
          </div>
          <div className="card bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md w-full">
